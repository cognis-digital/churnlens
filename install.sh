#!/usr/bin/env sh
# Universal installer for churnlens. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/churnlens.git"
echo "Installing churnlens ..."
