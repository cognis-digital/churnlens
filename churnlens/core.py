"""CHURNLENS core — Self-hosted SaaS metrics — MRR, churn, LTV from Stripe or CSV."""
...
RULES = [
    ("CHU-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("CHU-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("CHU-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
