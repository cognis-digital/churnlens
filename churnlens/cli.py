...
import argparse, sys
from churnlens.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="churnlens", description="CHURNLENS — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from churnlens.mcp_server import serve
        return serve()
    if args.cmd == "scan":
