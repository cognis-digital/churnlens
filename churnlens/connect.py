"""Native cognis-connect emit for churnlens — forward findings to any platform.

Maps churnlens's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    churnlens ... --format json | churnlens-emit --to stix
    churnlens-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
