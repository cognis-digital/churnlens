...
[![PyPI](https://img.shields.io/pypi/v/cognis-churnlens.svg)](https://pypi.org/project/cognis-churnlens/)
[![CI](https://github.com/cognis-digital/churnlens/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/churnlens/actions)
...
CHURNLENS exists for one job — self-hosted saas metrics — mrr, churn, ltv from stripe or csv — and does it without a SaaS bill or heavyweight setup.
...
```bash
churnlens --version
churnlens scan .                      # scan the current project
churnlens scan . --format json
churnlens scan . --fail-on high       # non-zero exit for CI gates
churnlens mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Baremetrics**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`churnlens` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
